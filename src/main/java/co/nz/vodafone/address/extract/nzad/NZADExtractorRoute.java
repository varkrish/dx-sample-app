...
public class NZADExtractorRoute extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		.setHeader("enrichEndPoint").constant(extractURL +"?"+ "httpClient.handleRedirects=true&httpClient.maxRedirects=3&disableStreamCache=true")
		...
		from ("seda:extractfiles")
			...
			.process( new Processor() {
				...
				public void process(Exchange exchange) throws Exception {
					...
					if (null==dispositionHeader) throw new Exception("Disposition Header Not found");
					String fileName="";
